...
const Banner = () => {
  return (
    <div className='relative h-[400px] sm:h-[500px] lg:h-[600px] xl:h-[600px]'>
      <Image
      src='https://images.unsplash.com/43/2EsHHwmRswlLYnaG07Ew_paris-motionbug.com.jpg?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
      alt='banner image'
      fill
